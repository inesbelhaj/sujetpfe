      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Modifier sous categories</h6>
			...
			<input type="text" class="form-control datepicker-input" name="categorie_nom"  value={{ $souscategorie->categorie_nom}}  >
            </div>
        </div>
       <div class="col-lg-6">
            <div class="form-group">
            <label for="categorie">libele categorie 1</label>
            <input type="text" class="form-control datepicker-input" name="categorie_libele1"  value={{ $souscategorie->categorie_libele1}}  >
            </div>
        </div>
            <div class="col-lg-6">
                    <div class="form-group">
                    <label for="categorie">unite</label>
                    <input type="text" class="form-control datepicker-input" name="categorie_unite1"  value={{ $souscategorie->categorie_unite1}}  >
                    </div>
                </div>
                <div class="col-lg-6">
                        <div class="form-group">
                        <label for="categorie">libele categorie 2</label>
                        <input type="text" class="form-control datepicker-input" name="categorie_libele2"  value={{ $souscategorie->categorie_libele2}}  >
                        </div>
                    </div>
                            <div class="col-lg-6">
                        <div class="form-group">
                        <label for="categorie">unite</label>
                        <input type="text" class="form-control datepicker-input" name="categorie_unite2"  value={{ $souscategorie->categorie_unite2}}  >
                        </div>
                    </div>
            <div class="col-lg-6">
			<input type="hidden" name="_token" value="{{ Session::token() }}">
            <button type="submit" class="btn btn-primary">Modifier categories</button>
        </div>
