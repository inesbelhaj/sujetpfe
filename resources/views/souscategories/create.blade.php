      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ajouter sous categories</h6>
			...
			<input type="text" class="form-control datepicker-input" name="categorie_nom"  required>
        </div>
    </div>
        <div class="col-lg-6">
            <div class="form-group">
        <label for="nom"> libele categorie 1</label>
			<input type="text" class="form-control datepicker-input" name="categorie_libele1"  required>
        </div>
    </div>
        <div class="col-lg-6">
            <div class="form-group">
        <label for="nom"> Unite</label>
			<input type="text" class="form-control datepicker-input" name="categorie_unite1"  required>
        </div>
    </div>
        <div class="col-lg-6">
            <div class="form-group">
        <label for="nom"> libele categorie 2</label>
			<input type="text" class="form-control datepicker-input" name="categorie_libele2"  required>
        </div>
    </div>
        <div class="col-lg-6">
            <div class="form-group">
        <label for="nom"> Unite</label>
			<input type="text" class="form-control datepicker-input" name="categorie_unite2"  required>
        </div>
    </div>
            <div class="col-lg-6">
                    <div class="container">
                            <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <button type="submit" class="btn btn-primary">Ajouter Categories</button>
                                        </div>
                        <div class="col-md-6">
                        <a href="{{ route('categories.index') }}" class="btn btn-primary">Annuler</a>
                    </div>
                            </div>
                        </div>
                    </div>
