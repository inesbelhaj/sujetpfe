      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ajouter  Article</h6>
			...
			<input type="text" class="form-control datepicker-input" name="produit_nom"  required   >
        </div>
    </div>
        ...
        <div class="col-lg-6">
                ...
                <input type="file" class="form-control datepicker-input" name="image"  required   >
            </div>
    </div>
        <div class="col-lg-6">
			<div class="form-group ">
			<label for="fournisseur">Categories</label>
            <select class="selectpicker " data-live-search="true" name="produit_categorie"   required>
        ...
        <div class="col-lg-6">
            <div class="form-group ">
                ...
                <input type="text" class="form-control" name="produit_caractere"   required>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="produit_code"   required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group ">
                        <label for="prenom">Reference</label>
                        <input type="text" class="form-control" name="produit_reference"   required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            <div class="form-group ">
                                <label for="tva">tva</label>
                                <input type="text" class="form-control" name="produit_tva"   required>
                                </div>
                            </div>
            <div class="col-lg-6">
			<div class="form-group ">
			<label for="prix">prix de vente</label>
			<input type="text" class="form-control" name ="produit_prixvent"  required >
			</div>
        </div>
