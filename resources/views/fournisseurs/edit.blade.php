    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
			...
			<input type="text" class="form-control datepicker-input" name="fournisseur_nom"  value={{ $fournisseur->fournisseur_nom}}  >
            </div>
        ...
        <div class="col-lg-6">
			...
			<input type="text" class="form-control datepicker-input" name="fournisseur_prenom"  value={{ $fournisseur->fournisseur_prenom }}  >
			</div>
			...
			<input type="text" class="form-control datepicker-input"name="fournisseur_contact" value={{ $fournisseur->fournisseur_contact }} >
            </div>
        </div>
            <div class="col-lg-6">
			<div class="form-group ">
			<label for="adresse">adresse</label>
			<input type="text" class="form-control" name ="fournisseur_adresse" value={{ $fournisseur->fournisseur_adresse }}  >
            </div>
        </div>
            <div class="col-lg-6">
			<div class="form-group ">
			<label for="Telephone">Telephone</label>
			<input type="text" class="form-control" name ="fournisseur_telephone" value={{ $fournisseur->fournisseur_telephone }}  >
			</div>
        </div>
            <div class="col-lg-6">
