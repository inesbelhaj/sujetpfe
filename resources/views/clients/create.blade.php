    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
			...
			<input type="text" class="form-control datepicker-input" name="client_nom"  required>
        </div>
    </div>
    <div class="col-lg-6">
			<div class="form-group ">
			<label for="prenom">prenom</label>
			<input type="text" class="form-control datepicker-input" name="client_prenom"   required>
			</div>
        </div>
			...
			<input type="text" class="form-control datepicker-input"name="client_contact"  required>
            </div>
        </div>
            <div class="col-lg-6">
			<div class="form-group ">
			...
			<input type="text" class="form-control" name ="client_telephone"   required>
			</div>
        </div>
            <div class="col-lg-6">
