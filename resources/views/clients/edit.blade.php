      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('clients.create') }}">Nouvel client</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
			...
			<input type="text" class="form-control datepicker-input" name="client_nom" value={{ $client->client_nom }}    >




			<label for="prenom">prenom</label>
			<input type="text" class="form-control datepicker-input" name="client_prenom"  value={{ $client->client_prenom }} >
			...
			<input type="text" class="form-control datepicker-input"name="client_contact" value={{ $client->client_contact }} >
			</div>

			<div class="form-group ">
			<label for="adresse">adresse</label>
			<input type="text" class="form-control" name ="client_adresse"  value={{ $client->client_adresse }}  >
            </div>


			<div class="form-group ">
			<label for="Telephone">Telephone</label>
			<input type="text" class="form-control" name ="client_telephone"   value={{ $client->client_telephone }} >
			</div>
