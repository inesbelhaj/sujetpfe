      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('admins.create') }}">Nouvel Utilisateur</a>
...
<div class="card-body">
        <nav class="navbar navbar-expand-md navbar-dark bg-info">
         <a class="navbar-brand" href="{{ route('admins.show',$admin->id)}}">Detail</a>
          <ul class="navbar-nav mr-auto">
           <li class="nav-item active">
        ...
        <div class="form-group ">
          <strong>Nom </strong>{{ $admin->admin_nom }}
       </div>

       <div class="form-group ">
            <strong>Prenom </strong>{{ $admin->admin_prenom }}

         </div>

         <div class="form-group ">
                <strong>Date de naissance </strong>{{ $admin->admin_naissance }}

             </div>
             <div class="form-group ">
                    <strong>Sexe </strong>{{ $admin->admin_sexe }}

        </div>
         <div class="form-group ">
            <strong>Adresse </strong>{{ $admin->admin_adresse }}

          </div>
          <div class="form-group ">
           <strong>Telephone  </strong>{{ $admin->admin_telephone }}

        </div>
         <div class="form-group ">
            <strong>Service </strong>{{ $admin->admin_categorie }}

          </div>
          <div class="form-group ">
            <strong>Login </strong>{{ $admin->admin_login }}

            </div>
             <div class="form-group ">
                <strong>Mot de passe </strong>{{ $admin->admin_pasword }}

             </div>
             <div class="col-md-12">
             <a href="{{ route('admins.index') }}" class="btn btn-primary">Retour</a>
            </div>
