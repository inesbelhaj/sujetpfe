 ...
 <!-- Nav Item - Pages Collapse Menu -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<input type="text" class="form-control datepicker-input" name="admin_nom"  required   >
        </div>
    </div>
         <div class="col-lg-6">
			<div class="form-group ">
			<label for="prenom">prenom</label>
			<input type="text" class="form-control datepicker-input" name="admin_prenom"   required >
			</div>
          </div>
          ...
          <div class="col-lg-6">
			...
			<input type="date" class="form-control datepicker-input" name="admin_naissance"  required >
			</div>
        </div>
        ...
        <div class="col-lg-6">
			...
			<select class="selectpicker " data-live-search="true" name="admin_sexe"   required>
        ...
        <div class="col-lg-6">
			...
			<input type="text" class="form-control" name ="admin_adresse"  required >
            </div>
        </div>
            <div class="col-lg-6">
			<div class="form-group ">
			<label for="Telephone">Telephone</label>
			<input type="text" class="form-control" name ="admin_telephone"  required >
			</div>
        </div>
        ...
        <div class="col-lg-6">
			...
			<select class="selectpicker " data-live-search="true" name="admin_categorie"  required >
    ...
    <div class="col-lg-6">
			...
			<input type="text" class="form-control" name="admin_pasword"   required>
        </div>
			</div>
