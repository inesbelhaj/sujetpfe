      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ajout Tva</h6>
			...
			<input type="text" class="form-control datepicker-input" name="conf_tva"  required>
        </div>

            <div class="col-lg-6">
			<input type="hidden" name="_token" value="{{ Session::token() }}">
            <button type="submit" class="btn btn-primary">Ajouter Tva</button>
        </div>
